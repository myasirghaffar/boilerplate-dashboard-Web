  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-7 shadow-[0_10px_30px_rgba(15,23,42,0.08)] md:p-9">
      ...
      <form onSubmit={handleSubmit} className="mt-7 space-y-4">
        ...
        <button
          type="submit"
          className="mt-3 w-full rounded-xl bg-gradient-to-r from-[#2f4d97] to-[#03153f] px-5 py-3 text-base font-medium text-white shadow-[0_12px_20px_rgba(15,23,42,0.2)] transition hover:opacity-95"
        >
          Send Message
        </button>
      </form>
